...
<body>
	<%
		...
		Statistics stat = new StatisticsDAO().getStatistics();
	%>
	<nav class="navbar navbar-default">
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			<ul class="nav navbar-nav">
				...
				<li class="active"><a href="statistic.jsp">통계</a>
			</ul>
    ...
    <div class="container">
		<div class="row">
			<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
				<thead>
					<tr>
						<th colspan="3" style="background-color: #eeeeee; text-align: center;">손익 통계</th>
					</tr>
				</thead>
				<tbody>
					<tr>
						<td>총 손실</td>
						<td colspan="2"><%= stat.getLoss() %></td>
					</tr>
					<tr>
						<td>총 이익</td>
						<td colspan="2"><%= stat.getProfit() %></td>
				</tbody>
			</table>
		</div>
	</div>
